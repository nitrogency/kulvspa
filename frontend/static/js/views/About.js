        ...
        return `
            <body class="min-h-screen bg-gray-900">
                <div class="flex flex-col items-center justify-start py-8 h-screen">
                    <h1 data-i18n-key="about_who" class="text-5xl font-extrabold dark:text-white pb-8">Who are we?</h1>
                    <div class="max-w-screen-xl">
                        <p data-i18n-key="about_p" class="text-lg font-normal lg:text-xl">
                    ...
                    <h1 data-i18n-key="about_why" class="text-5xl font-extrabold dark:text-white pb-8">Why "Kulvians"?</h1>
                    <div class="max-w-screen-xl">
                        <p data-i18n-key="about_abraomas" class="text-lg font-normal lg:text-xl">
                        ...
                        <p data-i18n-key="about_abraomas_late" class="text-lg font-normal lg:text-xl">
                        ...
                        <p data-i18n-key="about_abraomas_final" class="text-lg font-normal lg:text-xl">
